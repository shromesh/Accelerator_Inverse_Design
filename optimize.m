...
for k = 1:nComb
    ...
    %%% NEW %%% Ex 成分の出力（5回連結）【設計領域のみ表示】
    Ex_best_plot = Ex_field_1D{k};
    Ex_best_plot_design = Ex_best_plot(:, y_design_start:y_design_end);  %% CROPPED
